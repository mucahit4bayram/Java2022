...
public class C01 {
    ...
    public static void main(String[] args) {
       ...
       *** instance variable'lara static method'dan ulasmak istersek OBJE OLUÞTURMAMIZ gerekir.

        instance variable'lar obje variable'i oldugu icin herhangi bir satirda instance variable'in degerinin
        ne oldugunu bulmak icin;

  ***** OBJE OLUSTURULAN SATIRDAN itibaren kod incelenmelidir.
        (obje oluþturulduðunda instance variable'ýn deðeri baþlangýç deðeridir.)
        (int rakam =5;)

  ***** static variable'lar class variable'i oldugu icin
        herhangi bir satirda static variable'in degerini bulmak icin CLASSIN BASINDAN itibaren kod incelenmelidir.
        (class baþýndan itibaren yapýlan atamalar kalýcý oluyor.)
         */
