...
public class C06_DoWhileLoop {
    public static void main(String[] args) {
        ...
        */
        ...
        System.out.println(pozSayiAdedi + " adet pozitif sayi girdiniz, toplamlarý : " + pozSayilarTop);
        System.out.println(negSayiAdedi + " adet negatif sayi girdiniiz, ancak onlar toplama dahil edilmedi");
    }
}
