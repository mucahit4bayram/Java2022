...
public class C09_ArraydenListYapmak {
    public static void main(String[] args) {
        ...
        */
        ...
        List<Integer> sayilar= new ArrayList<>(); // boþ list oluþturalým
        ...
        2- asList method'u ile olusturulan liste ve kaynak olan array birbiri ile ilisik olarak
        hayatlarina devam ederler birinde yaptigimiz degisiklik, otomatik olarak digerine de isler
        ...
        sayilar.add(5); // sayýlar listesine 5 ekleyelim
        System.out.println(sayilar); // [2, 3, 5, 6, 8, 4, 2, 6, 9, 0, 1, 3, 6, 4, 2, 7, 0, 5]

        /*
        sayilar2.add(5); // sayýlar2 ye 5 ekleyelim
        System.out.println(sayilar2);
        exception verdigi icin yorum haline aldik
         */

        arr[0]=20;  // arr nin 0. elementini 20 olarak deðiþtirelim
