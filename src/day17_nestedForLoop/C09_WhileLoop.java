...
public class C09_WhileLoop {
    public static void main(String[] args) {
        ...
        ve BAÞARILI ÞÝFRE GÝRÝNCEYE KADAR TEKRAR ÞÝFRE GÝRMESÝNÝ ÝSTEYÝN.
        ...
        String sifre ="";
        boolean sifreBasariliMi = false;  // baþarýlý olursa iþlem bitimiþ olacak. dolayýsýyla false olmalý
        int kontrol =0;                   // 4 olunca baþarýlý olmuþ olaca.

        while(!sifreBasariliMi){   // burasý da false olursa çalýþmaz. dolayýsýyla ! koyduk
            ...
            if (kontrol==4){            // tum kontrolllerden gecmis demektir
                ...
                sifreBasariliMi=true;   // while loopun bitmesi için ekledik
