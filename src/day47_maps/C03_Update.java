...
public class C03_Update {
     ...
     **** ONEMLI NOT : map.contains(value) value'nun icindeki bir parcayi bulmada ise yaramaz
        ...
        //*** Daha önce Collection oluþturarak value lere eriþiyorduk,
        //*** Þimdi ise Set oluþturarak key lere ulaþabiliriz.

        Set<Integer> keySeti = sinifListMap.keySet(); // keySet() methodu bize ==> Integer'lardan oluþan set döndürüyor
        ...
        for (Integer each:keySeti // keySeti'inden integer key ler getirecek
            ...
            eachValue=eachValue.replace("JDev", "JavaDeveloper");// each value'nin deðerini deðiþtirdik
            sinifListMap.put(each,eachValue); // each value nun yeni deðerini sinifListMap'a koyduk
