    ...
    public static void main(String[] args) {
        ...
        /*
          ...
          2- eger esitigin saginda bir method calisiyor veya + islemi yapiliyorsa
             String immutable oldugundan degisikligi kaydetmek uzere hemen bir kopya String ve ref olusturur,
        ...
        /*
          ...
          new kelimesi kullanilmaz veya esitligin saginda + islemi olmazsa Java bakar;
          Eger daha once olusturulan String objelerden (String Havuzu)
********* bire-bir ayni String varsa o objeyi ve refreransini kullanir,

********* bire-bir aynisi yoksa yeni bir obje ve referans olusturur

    **** == hem deðerleri hemde referanslarý kontrol ediyor.
    ****  referansýn deðiþmediði durumda true veriyor.
    ****  referansýn deðiþtiði durumda false veriyor
         */
