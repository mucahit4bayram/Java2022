...
public class Tasit {
    ...
    // *** return olmadýðý icin bu methodun caðýrýldýðý tasitrunner classinden yazdirilamaz
    // *** burada bir satýrlýk islem yapýyor o bir satýrlýk islemde
    // *** bizim gönderdiðimiz parametreyi instence variable a atýyor.
