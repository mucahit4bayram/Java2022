...
public class C04_LinkedList_QueueDataTuru {
    public static void main(String[] args) {
        ...
        System.out.println(ll3.remove()); // Adem            // baþtan sildi
        ...
        //System.out.println(ll4.remove()); // throws exception NoSuchElementException // boþ listte remove
        System.out.println(ll4.poll()); // null                                        // boþ listte poll
    }
}
