...
public class C02_Append {
    public static void main(String[] args) {
        ...
        sb.append("Java",2,4);           // Java daha ne yapsin?va

        // append istedigimiz String'i en sona ekler

        sb.append("Java",2,4);           // Java daha ne yapsin?vava

        sb.insert(4," her seyi dusunmus,");

        System.out.println(sb);                      // Java her seyi dusunmus, daha ne yapsin?vava

        // araya ekleme yapmak istedigimizde append degil insert kullanmaliyiz

        sb.insert(22,"valla valla",5,11);
        System.out.println(sb); //Java her seyi dusunmus valla, daha ne yapsin?vava
